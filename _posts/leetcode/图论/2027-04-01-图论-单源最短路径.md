...
<!-- 这是一张图片，ocr 内容为：DIJKSTRA算法-单源最短路代算法 顶点 最短距离 上一个顶点 A 2 D E 7 -->
![](https://cdn.nlark.com/yuque/0/2022/png/32473878/1667923464678-f5b12025-f143-41c4-82fc-0662815a3fa8.png)
...
<!-- 这是一张图片，ocr 内容为：100 S -200 1 -->
![](https://cdn.nlark.com/yuque/0/2024/png/32473878/1715222440272-be592581-7aa7-47f3-9af3-9476cff7cf7d.png)
...
<!-- 这是一张图片，ocr 内容为：为什从DIKSTRA算法不能在负取国工作 -->
![](https://cdn.nlark.com/yuque/0/2023/png/32473878/1683095524974-c6277318-8ff5-48b6-8bb2-ee3089061add.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](http://139.198.106.15/wp-content/uploads/2022/08/image-20220811223010664.png)

<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/32473878/1715336251493-b53b581a-02a4-40ca-95aa-d562c02d3ab7.png)
...
<!-- 这是一张图片，ocr 内容为：200 3 O -150 100 100 2 -100 -->
![](https://cdn.nlark.com/yuque/0/2023/png/32473878/1683098775474-041b0b35-1e44-4cb0-b390-854b5aa78cb5.png)

  

| 经历最多k条边\ 目标点u | u=0 | u=1 | u=2 | u=3 |
| --- | --- | --- | --- | --- |
| k=0 | $ dp[0][0] = 0 $ | $ dp[0][1] = \infty $ | $ dp[0][2] = \infty $ | $ dp[0][3] = \infty $ |
...
<!-- 这是一张图片，ocr 内容为：提汁 次失 0 8 8 SU 0 - 150 001 00 2 0 AP/ O 3 CO1 次和 0 C 一三四 -->
![](https://cdn.nlark.com/yuque/0/2023/png/32473878/1683100160001-011ce9b6-c64a-492f-bf32-f002f62482a1.png)
...
SPFA(<font style="color:rgb(38, 38, 38);">Shortest Path Faster Algorithm</font>) 是对BF算法的一种改进，「SPFA」算法是通过队列来维护我们接下来要遍历的起点，而不是「BF」算法中的任意还没有遍历过的边。每次只有当某个顶点的最短距离更新之后，并且该顶点不在「队列」中，我们就将该顶点加入到「队列」中。一直循环以上步骤，直到队列为空，就可以终止算法。
