...
<!-- 这是一张图片，ocr 内容为：KEY NEXT PREV / L.HEAD 16 -->
![](https://cdn.nlark.com/yuque/0/2023/png/32473878/1678968573648-9ff8a69e-c9ae-4162-a303-bdb20aaf9464.png)
...
<!-- 这是一张图片，ocr 内容为：1.使用给定值初始化新结点 CUR PREV NEXT VAL CUR 字段链接到 的 的下一个结点 2.将 NEXT CUR NEXT PREV PREV NEXT VAL CUR 字段链接到 中的NEXT 3.将 PREV CUR PREV NEXT VAL CUR -->
![](https://cdn.nlark.com/yuque/0/2024/png/32473878/1711190952651-ed64ae04-cbc7-4d55-bb89-602e35a71be1.png)
...
<!-- 这是一张图片，ocr 内容为：C L U A B -->
![](https://cdn.nlark.com/yuque/0/2023/png/32473878/1678974202092-dca8c67a-5e05-4ece-8230-3cf3ac208738.png)
...
<!-- 这是一张图片，ocr 内容为：B -->
![](https://cdn.nlark.com/yuque/0/2023/png/32473878/1679058273947-fabcabfa-fc15-46d6-91db-3edc1e5db4b5.png)
...
#### 单向链表
<!-- 这是一张图片，ocr 内容为：SIZE:2 3 2 O NULL 个 NODE AT INDEX 1 NODE AT INDEX 0 SENTINEL -->
![](https://cdn.nlark.com/yuque/0/2023/png/32473878/1679625982146-15c26004-0825-43a0-91c5-ab68ddcbe466.png)
...
<!-- 这是一张图片，ocr 内容为：NULL NULL 力扣 NULL NULL NULL NULL MALCODE 6 NULL 5 -->
![](https://cdn.nlark.com/yuque/0/2023/png/32473878/1679789388110-757f7d13-872f-4bd5-8f25-a87b52e531ad.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2023/png/32473878/1679792603842-c846b6fe-b9ce-4b1c-95ea-90fb00bae2d1.png)
...
<!-- 这是一个文本绘图，源码为：graph LR
      ...
      slow --> fast;
     -->
![](https://cdn.nlark.com/yuque/__mermaid_v3/78c2055340980a0bfb9932d0e71109a9.svg)
...
<!-- 这是一个文本绘图，源码为：graph LR
      ...
      fast --> slow;
     -->
![](https://cdn.nlark.com/yuque/__mermaid_v3/6cb0539a0921198d9b6dac94760c22d9.svg)
...
<!-- 这是一个文本绘图，源码为：graph LR
	prev --> cur
	cur --> next -->
![](https://cdn.nlark.com/yuque/__mermaid_v3/8bcbb72a82478085a85c6d1f779eadbe.svg)

<!-- 这是一个文本绘图，源码为：graph RL 
	cur --> prev
	next
 -->
![](https://cdn.nlark.com/yuque/__mermaid_v3/092e7aae18fdfaa9d0fadb936cfce609.svg)
