...
<!-- 这是一张图片，ocr 内容为：0-1背包:有N个物品,第1个物品的体积为WLL],价值为0/ 每个物品至多选一个,求体积和不超过CAPACITY时的最大价值和 当前操作?枚举第I个物品选或不选: 不选,剩余容量不变;选,剩余容量减少 子问题?在剩余容量为C时, 从前?个物品中得到的最大价值和 回溯三问 下一个子问题?分类讨论: 不选:在剩余容量为C,时, 从前I-1个物品中得到的最大价值和 选:在剩余容量为C-W[]时, 从前I-1个物品中得到的最大价值和 DFS(I,C)-MAX(DFS(I-1,C),DFS(I-1,C-WLI)+ULI)+ULI) -->
![](https://cdn.nlark.com/yuque/0/2023/png/32473878/1685316221705-2b3541b5-e311-4dcb-b20d-99b58e420148.png)<!-- 这是一张图片，ocr 内容为：至多装CAPACITY,求方案数/最大价值和 常见变形 恰好装CAPACITY,求方案数/最大/最小价值和 至少装CAPACITY,求方案数/最小价值和 DFS(I,C)DFS(I,C1,C)+DFS(I,C1,C-WLI) FL门[E-FLI[E-1][E-1][E-WLI] FLI[D][EF月[D][E-WL司] -->
![](https://cdn.nlark.com/yuque/0/2023/png/32473878/1685317422149-1c3551bd-3ff4-4851-84ea-5044490522c8.png)
...
![](https://cdn.nlark.com/yuque/__mermaid_v3/c27a70fe1068277211a1052f0afaeb4d.svg)
...
<!-- 这是一张图片，ocr 内容为：至多装CAPACITY,求方案数/最大价值和 常见变形 恰好装CAPACITY,求方案数/最大/最小价值和 至少装CAPACITY,求方案数/最小价值和 DFS(I,C)DFS(I,C1,C)+DFS(I,C1,C-WLI) FL门[E-FLI[E-1][E-1][E-WLI] FLI[D][EF月[D][E-WL司] -->
![](https://cdn.nlark.com/yuque/0/2023/png/32473878/1685317422149-1c3551bd-3ff4-4851-84ea-5044490522c8.png)
...
<!-- 这是一个文本绘图，源码为：graph TD
	...
	N --> |"-2"| O("2");
	N --> |"-0"| P("4");  -->
![](https://cdn.nlark.com/yuque/__mermaid_v3/27d7478e733e7b931f5640b3551e0022.svg)
